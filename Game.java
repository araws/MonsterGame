...
public class GameBoard {
...

    {
        switch (gameBoardField) {
            case EASY:
                this.row = Game.GameDifficulty.EASY.getBoardHeight() + FRAME;
                this.column = Game.GameDifficulty.EASY.getBoardWidth() + FRAME;
                break;
            case MEDIUM:
                this.row = Game.GameDifficulty.MEDIUM.getBoardHeight() + FRAME;
                this.column = Game.GameDifficulty.MEDIUM.getBoardWidth() + FRAME;
                break;
            case HARD:
                this.row = Game.GameDifficulty.HARD.getBoardHeight() + FRAME;
                this.column = Game.GameDifficulty.HARD.getBoardWidth() + FRAME;
                break;
        }
    }
}
